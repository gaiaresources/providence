...
$substr	= substr($vs_field_name_prefix, 0, strlen($vs_field_name_prefix) - 1);
?>
				...
				$.ajax({
					...
					success: function(resp, textStatus) {
						if (resp.status == 0) {
							...
							var displayContent = jQuery('#caRelationEditorPanel<?= $substr; ?> .caBundleDisplayTemplate').template(resp.bundleDisplay);
